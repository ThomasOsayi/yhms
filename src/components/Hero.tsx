      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[calc(100vh-100px)]">
        <div className="flex flex-col justify-center px-8 lg:px-16 xl:pl-[max(32px,calc((100vw-1280px)/2+32px))] py-16 lg:pr-16">
          <motion.h1
            ...
            className="font-serif font-extrabold text-[clamp(42px,5vw,68px)] leading-[1.05] tracking-tight text-brand-dark mb-6"
          >
          ...
          <motion.p
            ...
            className="text-lg text-brand-text-light max-w-[440px] leading-relaxed mb-9"
          >
        ...
        <div className="relative p-8 lg:pr-8 lg:py-8 lg:pl-0">
          <div className="grid grid-cols-[1.2fr_1fr] grid-rows-2 gap-4 h-full min-h-[400px]">
            <motion.div
              ...
              className="row-span-2 rounded-xl overflow-hidden img-zoom"
            >
              <Image
            ...
            <motion.div
              ...
              className="rounded-xl overflow-hidden img-zoom"
            >
              <Image
